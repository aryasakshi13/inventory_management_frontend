  ...
  const [selectedOfficeName, setSelectedOfficeName] = useState(
    ...
    const fetchItemsCatalog = async () => {
        try {
            setIsLoading(true);
            setErrorMsg('');
            // const response = await axios.get('https://www.namami-infotech.com/inventory/api/items', {
            //     withCredentials: true
            // });
             
            const response = await axios.get(`https://www.namami-infotech.com/inventory/api/items?officeId=${selectedOffice}&itemId=${selectedItem}`, {
                withCredentials: true
            });
     ...
     useEffect(() => {
        const loadFilterOptions = async () => {
            try {
                ...
                const offRes = await axios.get('https://www.namami-infotech.com/inventory/api/branch?limit=1000', { withCredentials: true });
                ...
                const itemRes = await axios.get('https://www.namami-infotech.com/inventory/api/items', { withCredentials: true });
