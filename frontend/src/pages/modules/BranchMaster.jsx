...
const BranchMaster = ({ userRole, fetchDatabaseRegistry }) => {
    ...
    const fetchOffices = useCallback(async () => {
        try {
            setIsLoading(true);
            const res = await axios.get(`https://www.namami-infotech.com/inventory/api/branch?page=${currentPage}&limit=${rowsPerPage}&search=${debouncedSearch}`, { withCredentials: true });
    ...
    //     const result = await axios.get(`https://www.namami-infotech.com/inventory/api/auth/employees`);
