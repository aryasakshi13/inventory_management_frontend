            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-gray-900">
                  Delivery: <span className="text-blue-600">{challan.challan_no}</span>
                </h2>
                <span
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          {(() => {
            const isDirectDelivery =
              challan.receipt_status === 'Direct Delivery' ||
              challan.receipt_status === 'Not Applicable' ||
              !challan.preparation_id ||
              String(challan.fulfilment_mode || '').includes('in_house') ||
              String(challan.order_type || '').includes('in_house') ||
              !challan.site_engineer_name ||
              challan.site_engineer_name === 'Not Assigned' ||
              challan.site_engineer_name === 'N/A';

            return (
              <>
                <div className={`grid grid-cols-1 ${isDirectDelivery ? 'sm:grid-cols-2' : 'sm:grid-cols-3'} gap-3`}>
                  ...
                  <div className="bg-gray-50 p-3.5 rounded-xl border border-gray-200 space-y-2">
                    ...
                    <div className="space-y-1 text-gray-600 text-[11px]">
                      ...
                      <div className="flex justify-between items-start pt-0.5">
                        ...
                        <span className="font-medium text-gray-800 text-right pl-2 truncate max-w-[160px]" title={challan.delivery_address}>
                  ...
                  {/* Site Engineer & Material Receipt Info (Only for Site Deliveries) */}
                  {!isDirectDelivery && (
                ...
                {/* Prominent Site Verification & Engineer Remarks Banner (Only for Site Deliveries) */}
                {!isDirectDelivery &&
                  challan.receipt_status &&
                  challan.receipt_status !== 'Pending Receipt' &&
                  challan.receipt_status !== 'Pending' &&
                  challan.receipt_status !== 'Direct Delivery' && (
                    <div
          ...
          <div className="bg-gradient-to-r from-blue-50 via-indigo-50 to-slate-50 p-3.5 rounded-xl border border-blue-100 flex flex-wrap justify-between items-center gap-3">
            ...
            <div className="flex flex-wrap items-center gap-3 font-mono text-xs">
              ...
              <div className="bg-blue-600 text-white px-3 py-1.5 rounded-lg shadow-2xs">
                <span className="text-[10px] text-blue-100 block">This Delivery</span>
              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead className="bg-gray-100 text-gray-700 font-bold uppercase text-[10px] border-b border-gray-200">
                  <tr>
                    ...
                    <th className="py-2.5 px-3 w-24 text-right bg-blue-50/70 text-blue-900">This Delivery</th>
